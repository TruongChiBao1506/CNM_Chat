...
class MemberService {
   ...
   * @returns Lấy danh sách tất cả các thành viên trong một cuộc hội thoại.
   */
  async getList(conversationId, userId) {
    await Member.getByConversationIdAndUserId(conversationId, userId);

    // Lấy thông tin chi tiết của tất cả các thành viên trong cuộc hội thoạ
   ...
   * @param {*} conversationId : id của cuộc hội thoại
   * @param {*} userId : id của user
   * @returns Cho phép một thành viên rời khỏi nhóm trò chuyện.
   */
   ...
   * 
   * @param {*} conversationId : id của cuộc hội thoại
   * @param {*} myId : id của user
   * @returns Tham gia vào một nhóm trò chuyện thông qua liên kết.
   ...
   *
   * @param {*} conversationId : id của cuộc hội thoại
   * @param {*} newManagerIds : id của user cần thêm làm quản trị viên
   * @param {*} myId : id của user
   * @returns Thêm quản trị viên (managers) mới vào nhóm trò chuyện.
   */
   ...
   *
   * @param {*} conversationId : id của cuộc hội thoại
   * @param {*} deleteManagerIds : id của user cần xóa khỏi quản trị viên
   * @param {*} myId : id của user
   * @returns Xóa quản trị viên khỏi nhóm trò chuyện.
   */
