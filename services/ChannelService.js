...
class ChannelService {
   ...
   * @returns  Lấy danh sách các kênh (channels) thuộc một cuộc hội thoại cụ thể.
   */
  async getAllByConversationId(conversationId, userId) {
    // Xác thực người dùng (userId) có thuộc cuộc hội thoại (conversationId) hay không
  ...
  // Tính số lượng tin nhắn chưa đọc trong kênh (channelId) cho người dùng
