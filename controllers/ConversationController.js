...
class ConversationController {
  ...
  async getOne(req, res, next) {
    ...
    try {
      const conversation = await conversationService.getSummaryByIdAndUserId(
        id,
        _id
      );
  ...
  async getListByClassifyId(req, res, next) {
    ...
    try {
      const conversations = await conversationService.getListFollowClassify(
        classifyId,
        _id
      );
  ...
  async createIndividualConversation(req, res, next) {
    ...
    try {
      const result = await conversationService.createIndividualConversation(
        _id,
        userId
      );
  ...
  async updateAvatar(req, res, next) {
    ...
    try {
      const { avatar, lastMessage } = await conversationService.updateAvatar(
        id,
        file,
        _id
      );
  ...
  async updateAvatarWithBase64(req, res, next) {
    ...
    try {
      const { avatar, lastMessage } =
        await conversationService.updateAvatarWithBase64(id, req.body, _id);
  ...
  async getLastViewOfMembers(req, res, next) {
    ...
    try {
      const lastViewOfMembers = await conversationService.getLastViewOfMembers(
        id,
        _id
      );
